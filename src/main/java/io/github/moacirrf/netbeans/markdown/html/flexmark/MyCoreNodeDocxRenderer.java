...
import static com.vladsch.flexmark.docx.converter.DocxRendererPhase.COLLECT;
import static com.vladsch.flexmark.docx.converter.DocxRendererPhase.DOCUMENT_BOTTOM;
import static com.vladsch.flexmark.docx.converter.DocxRendererPhase.DOCUMENT_TOP;
...
import static com.vladsch.flexmark.ext.tables.TableCell.Alignment.CENTER;
import static com.vladsch.flexmark.ext.tables.TableCell.Alignment.LEFT;
import static com.vladsch.flexmark.ext.tables.TableCell.Alignment.RIGHT;
 ...
 */
public class MyCoreNodeDocxRenderer implements PhasedNodeDocxRenderer {
    ...
    public MyCoreNodeDocxRenderer(DataHolder options) {
    ...
    public Set<NodeDocxRendererHandler<?>> getNodeFormattingHandlers() {
        return new HashSet<>(Arrays.asList(
                ...
                new NodeDocxRendererHandler<>(Node.class, MyCoreNodeDocxRenderer.this::render),
                // core and extension nodes
                new NodeDocxRendererHandler<>(AsideBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(AttributeNode.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(AttributesNode.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(AutoLink.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(BlankLine.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(BlockQuote.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(BulletList.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(BulletListItem.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Code.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Document.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Emoji.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Emphasis.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(EnumeratedReferenceBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(EnumeratedReferenceLink.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(EnumeratedReferenceText.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(FencedCodeBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Footnote.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(FootnoteBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(GitLabBlockQuote.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(GitLabDel.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(GitLabIns.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HardLineBreak.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Heading.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlCommentBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlEntity.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlInline.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlInlineComment.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlInnerBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(HtmlInnerBlockComment.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Image.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(ImageRef.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(IndentedCodeBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Ins.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(JekyllTag.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(JekyllTagBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Link.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(LinkRef.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(MacroDefinitionBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(MacroReference.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(MailLink.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(OrderedList.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(OrderedListItem.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Paragraph.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Reference.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(SimTocBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(SoftLineBreak.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Strikethrough.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(StrongEmphasis.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(StrongEmphasis.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Subscript.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Superscript.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableBlock.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableBody.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableCaption.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableCell.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableHead.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableRow.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TableSeparator.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(Text.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TextBase.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(ThematicBreak.class, MyCoreNodeDocxRenderer.this::render),
                new NodeDocxRendererHandler<>(TocBlock.class, MyCoreNodeDocxRenderer.this::render)
        ));
    }
...
private void render(SoftLineBreak node, DocxRendererContext docx) {
    ...
    private void render(HtmlBlock node, DocxRendererContext docx) {
        ...
        if (node.hasChildren()) {
            ...
            if (imageNodeHelper.isImageNode(node)) {
                //render img tag
                renderHtmlBlockImage(node, docx);
            } else {
    ...
    private void render(Image node, DocxRendererContext docx) {
        imageNodeHelper.renderImage(node);
    ...
    private R renderImage(DocxRendererContext docx, ResolvedLink resolvedLink, MutableAttributes attributes, double scale) {
        ...
        if (ImageUtils.isEncodedImage(url)) {
            ...
            } else if (resolvedContent.getStatus() == LinkStatus.UNKNOWN) {
...
if (type.isEmpty() || text.equals(type + ":")) {
            ...
            enumeratedOrdinals.renderReferenceOrdinals(text, new OrdinalRenderer(MyCoreNodeDocxRenderer.this, docx));
        }
    }
